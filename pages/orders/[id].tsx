            ...
            <Grid item xs={ 12 } sm={ 5 }>
                <Card className='summary-card'>
                    <CardContent>
                        ...
                        <Typography>Elias Miccio</Typography>
                        <Typography>Calle Flasa 123</Typography>
                        <Typography>Mar del Plata, Buenos Aires</Typography>
                        <Typography>Argentina</Typography>
                        <Typography>2236146208</Typography>
